...
<html lang="en">
	<head>
		...
		<title>Staf | Daftar Penyelenggaraan</title>
		<!-- Bootstrap core CSS -->
			...
			<div class="row">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Daftar Penyelenggaraan</li>
				  </ol>
				</nav>
				...
				<section>
					...
					<td><br><input name="maintenance_desc" type="text"  value="" size="50" maxlength="50" class="form-control" required>
								...
								<tr align="center">
									<td colspan="2">
										<br>
										<input type="submit" name="maintenance_asset" value="Daftar" class="btn btn-primary form-control">
									</td>
								</tr>
							</TABLE>
						</form>

...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 16, 2018 at 04:12 AM
...
(1, 'Muktamar 1', 'Muktamar 1', '2018-12-13', '01:03:00', 'DSS', 'Ahli', 'Muktamar', 20, 111111111111, NULL),
...
('1', 4, 212312, 'Makanan untuk penceramah');
...
INSERT INTO `event` (`member_ic`, `activity_id`) VALUES
(111111111111, 4);
...
INSERT INTO `family` (`family_ic`, `family_name`, `family_address`, `family_gender`, `family_phone`, `family_dob`, `family_email`, `family_relation`, `member_ic`) VALUES
('955014205555', 'sada', 'test', 'Lelaki', '12341231242', '2018-12-07', 'test@asdad', 'Isteri', '111111111111');
...
(1, 950514025299, 1, 1, 4, 2, 1, 5, 1, 2, 4, 5, 1),
(2, 950514025299, 2, 3, 1, 2, 1, 5, 1, 2, 1, 5, 1),
(3, 950514025299, 2, 3, 1, 2, 1, 5, 1, 2, 1, 5, 1),
(4, 950514025299, 2, 3, 2, 2, 1, 5, 1, 2, 1, 5, 1),
(5, 950514025299, 2, 3, 3, 2, 2, 5, 1, 2, 1, 5, 1);

...
$sql = mysqli_query($myConnection,"SELECT `member`.*,`occupation_info`.* FROM `member` 
INNER JOIN  `occupation_info` ON `member`.`mbr_ic` = `occupation_info`.`member_ic`
...
<div class="tab">
  <?php
    $sql = "SELECT * FROM `occupation_info` WHERE `member_ic` = '$id' AND `company_end_date` != 'Semasa'";

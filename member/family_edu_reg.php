...
<html lang="en">
	<head>
		...
		<title>Ahli | Daftar Pendidikan Keluarga</title>
		<!-- Bootstrap core CSS -->
			...
			<div class="row">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Daftar Pendidikan Keluarga</li>
				  </ol>
				</nav>
				...
				<section>
								...
								<div align="center">
								<h1><br>DAFTAR PENDIDIKAN KELUARGA</h1></br>

						<form action="controller.php" method="post">
							<TABLE border="0" cellpadding="5" cellspacing="2">
								<tr>
									<td colspan="2"><center><b>MAKLUMAT PENDIDIKAN KELUARGA</b></center></td> 
								</tr>

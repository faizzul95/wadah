				...
				<section>
								...
								<TABLE border="0" cellpadding="5" cellspacing="2">
									<form method="post" action="controller.php">
											<tr>
												<td>Penceramah  IC :</td>
												<td><br><input name="speak_id" type="text" maxlength = "11" size="50" autocomplete="off" required oninput="maxLengthCheck(this)"
							                     type = "text"
									  ...
									  <tr>
												<td>Nama :</td>
												<td><br><input name="speak_name" type="text" autocomplete="off" size="50" maxlength="500" oninput="maxLengthCheck(this)"
							                     type = "text"
							                     maxlength = "250" class="form-control" required></td>
											</tr>
                                              <tr>
												<td>Jawatan :</td>
												<td><br><input name="speak_position" type="text" autocomplete="off" size="50" maxlength="500" oninput="maxLengthCheck(this)"
							                     type = "text"
							                     maxlength = "250" class="form-control" required></td>
											</tr>
											<tr>
											...
											<tr>
												<td>Emel:</td>
												<td><br> <input name="speak_mail" type="text" autocomplete="off" size="50" maxlength="500" oninput="maxLengthCheck(this)"
							                     type = "text"
											...
											<tr align="center">
												<td colspan="2"> <br>
													<input type="submit" name="register_penceramah" value="Daftar" class="btn btn-primary">
												</td>
											</tr>

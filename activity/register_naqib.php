								...
								<TABLE border="0" cellpadding="5" cellspacing="2">
									<form method="post" action="controller.php">
											<tr>
												...
												<td><br><input name="naqib_id" type="text" maxlength = "11" size="50" autocomplete="off" required oninput="maxLengthCheck(this)"
							                     type = "text"
									  ...
									  <tr>
												<td>Nama :</td>
												<td><br><input name="naqib_name" type="text" autocomplete="off" size="50" maxlength="500" oninput="maxLengthCheck(this)"
							                     type = "text"
											...
											<tr>
												<td>Emel:</td>
												<td><br> <input name="naqib_mail" type="text" autocomplete="off" size="50" maxlength="500" oninput="maxLengthCheck(this)"
							                     type = "text"
											...
											<tr align="center">
												<td colspan="2"> <br>
													<input type="submit" name="register_naqib" value="Daftar" class="btn btn-primary">
												</td>
											</tr>
